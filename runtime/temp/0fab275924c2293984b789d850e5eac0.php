<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp\www\mobadmin\public/../application/admin\view\index\index.html";i:1513677670;}*/ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear">
                                <span class="block m-t-xs"><strong class="font-bold"><?php echo \think\Session::get('admin_name'); ?></strong></span>
                                <span class="text-muted text-xs block"><?php echo \think\Session::get('role_name'); ?><b class="caret"></b></span>
                            </span>
                        </a>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                    src="<?php echo url('Index/welcome'); ?>" frameborder="0"
...
<script src="__PLUGINS__/metisMenu/jquery.metisMenu.js"></script>
<script src="__PLUGINS__/slimscroll/jquery.slimscroll.min.js"></script>
...
<script type="text/javascript" src="__JS__/contabs.js?ver=1.3"></script>
