<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp\www\mobadmin\public/../application/admin\view\admin\mb_index.html";i:1513242404;s:72:"D:\wamp\www\mobadmin\public/../application/admin\view\mobile_header.html";i:1513224446;s:72:"D:\wamp\www\mobadmin\public/../application/admin\view\mobile_footer.html";i:1513237526;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    var g = {
        api:{
            list:"<?php echo url('admin/admin/index'); ?>",
            edit:"<?php echo url('admin/admin/adminAddEdit'); ?>",
            del:"<?php echo url('admin/admin/adminDel'); ?>"
        },
        param:{ //查询参数
            pageNumber:1,
            pageSize:10,
