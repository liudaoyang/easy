<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wamp\www\mobadmin\public/../application/admin\view\login\index.html";i:1513331442;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo config('site_theme') ?>后台登录</title>
    ...
    <!--[if lt IE 9]>
    <script>
    	alert('推荐使用chrom或火狐浏览器，360的请使用兼容模式');
    </script>
    <![endif]-->
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong><?php echo config('site_theme') ?></strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" action="../index.html">
                <p class="m-t-md" id="err_msg">登录到<?php echo config('site_theme') ?></p>
